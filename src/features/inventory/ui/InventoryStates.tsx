...
export function InventoryError({ error }: { error: Error }) {
  return (
    <div className="rounded-xl border border-destructive/50 bg-destructive/10 p-6 flex flex-col items-center justify-center text-center text-destructive h-[400px]">
      ...
      <h3 className="text-lg font-bold mb-1">Error de Inventario</h3>
...
export function InventoryEmpty() {
  return (
    <div className="rounded-xl border p-12 flex flex-col items-center justify-center text-center text-muted-foreground h-[400px] bg-card/50">
      <ServerCrash className="h-12 w-12 mb-4 opacity-20" />
      <h3 className="text-lg font-medium mb-1">Inventario Vacío</h3>
      <p className="text-sm max-w-sm mx-auto">
        No se encontraron equipos registrados en esta bodega virtual bajo los filtros actuales.
      </p>
    </div>
  )
}
